...
- **Buiten de cookiebanner.** Deze tracker staat, anders dan de trackers
  hierboven, níet achter toestemming en meet dus elke bezoeker. Dat is een
  expliciete keuze van Rinse, geen vergissing. Let op dat first-party alleen
  bepaalt of browsers de cookie bewaren, niet of toestemming vereist is: onder de
  AVG geldt die plicht ook voor first-party cookies. Wil je dit terugdraaien, dan
  verhuist het blok naar `riyLoadConsentedScripts`.

Formulierinzendingen staan hier los van: die gaan via de Pardot-formulieren zelf,
niet via de paginatracker.
