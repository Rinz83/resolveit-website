---
title: "How does automatic direct debit work in the Billing Platform?"
description: "From invoice to collected payment, fully automatic. Discover how the collection process, with smart retry logic, delivers a stable cash flow."
pubDate: 2026-01-09
...
The system is fully integrated into Salesforce. The moment an invoice is created, the platform knows when and how the payment should be collected, and sets the collection in motion automatically. This is especially valuable for organisations with recurring revenue and subscriptions, where disciplined collection makes all the difference.
...
The customer experiences convenience: paying happens automatically, in the familiar way. At the same time, your finance team retains full control and oversight. Dashboards show payment intents, successful and failed collections, and subscriptions without an active payment method.
