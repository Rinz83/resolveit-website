---
title: "Integrating SharePoint and Salesforce: a seamless connection"
description: "Manage documents from within Salesforce, stored in SharePoint. Discover which problems the integration solves and what it delivers for your organisation."
pubDate: 2026-03-07
...
1. **Install**: after installation, the module appears directly in Salesforce, ready for use.
2. **Save**: you save documents as you are used to; the connection takes care of the rest in the background.
3. **Synchronise**: files land automatically in SharePoint, in a folder structure that follows your Salesforce objects.
4. **Collaborate**: you open, edit and share from both platforms, and changes synchronise throughout the whole organisation.
...
If you would like the transition to be guided, our consultants take care of the [implementation and onboarding](/en/diensten/implementatie). They set up the connection, guide the migration and make sure your team can work with it straight away.
...
Curious how SalesPoint clears up your document chaos? Visit the [product page](/en/producten/sharepoint) for all the functionality and licences, or [contact us](/en/contact) for a demo or a free trial period. We would be pleased to show you how the connection works in your own Salesforce environment.
